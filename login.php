...
if(ISSET($_POST['submit']))
{
    ...
    $sql="SELECT * from protectivering where user ='".$username."' AND pwd='".$password."' limit 1";
...
<header id="header" class="fixed-top ">
 <div class="container d-flex align-items-center">
   ...
   <h1 class="logo me-auto"><a href="home.html">PROTECTIVE RING</a></h1>
...
<form method="POST" action="login.php">
     ...
     <label for="naame"><b> Password</b></label>
     <input type="text" placeholder="password" name="pwd" required><br><br>

     <label for="naame"><b> E-mail id</b></label>
     <input type="text" placeholder="password" name="email" required><br><br>
     
     <hr>
     <button type="submit" class="btn btn-primary mt-4" name="submit">sign in</button>
     <input type="reset">
     </div>
